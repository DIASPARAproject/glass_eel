...
The time series in Den Oever is a long glasseel survey time-series
starting in 1938. Since 1960 glasseel lengths are estimated, with a
break between 20xx and 2012. Untill XXX a sample of 150 glasseels was
taken every week and the lengths were measured with live glasseels
onsite after anesthesia with XXX. Since 2012 a sample of xxx was taken
every xxx, because the number of caught glasseels per haul had declined
dramatically. In the Netherlands the main glasseel season is from march
to june.
...
```{r Process data, include=FALSE, eval=TRUE}
